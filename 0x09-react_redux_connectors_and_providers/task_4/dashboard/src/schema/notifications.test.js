...
describe("Tests notifications schema", () => {
  it("Testing getAllNotificationsByUser method", () => {
    // using this id should return the correct result
...
it("Tests normalized notifications data, , verify that data has a correct users entity with id.", () => {
  ...
  expect(normalizedData.entities.users[id]).toEqual(expected);
});

it("Tests normalized notifications data, verify that data has a correct messages entity with id.", () => {
